    ...
    <div className="w-full">
      <div className="w-screen h-[50vh] relative">
        ...
        <Image
          ...
          fill
          objectFit="cover"
          src="/assets/projects/PaperEdge.png"
          alt="/"
        />
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
          <h2 className="py-2">PaperEdge</h2>
          <h3>TypeScript | React | Node.js | Express | Supabase</h3>
        </div>
      </div>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
        <div className="col-span-4">
          ...
          <p className="mt-4">
            PaperEdge is a full-stack betting management application built with
            Vite, React, and TypeScript. The frontend delivers a responsive,
            mobile-first experience using Tailwind CSS and Radix UI components.
          ...
          <a href="https://paperedge.bet" target="_blank" rel="noreferrer">
            <button className="px-8 py-2 mt-4 mr-8">Live Site</button>
          </a>
          <a
            href="https://github.com/nicogarbaccio/paperedge"
            target="_blank"
            rel="noreferrer"
          >
