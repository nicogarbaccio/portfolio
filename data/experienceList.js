export default [
  {
    ...
    companySite: "http://www.funnelleasing.com",
    duration: "June 2024 - Present",
    details: `Develop and execute comprehensive test plans and test cases based on user stories and technical requirements within an Agile/Scrum environment, ensuring quality and coverage of complex technical features. Identify opportunities for automation and write Playwright tests for key areas of the product. Collaborate closely with cross-functional teams, including developers, to identify, document (using Jira), and resolve bugs and defects, ensuring high-quality software releases. Test and evaluate AI chatbot performance and conversational accuracy using LangSmith, focusing on accuracy, consistency, and identifying gaps in responses generated by OpenAI's technology. Create and present comprehensive documentation on automation testing processes and the automation product to different departments, ensuring clarity and understanding across teams.`,
  },
  {
