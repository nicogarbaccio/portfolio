...
function ProjectItem({ title, backgroundImg, stack, projectUrl }) {
  return (
    <div className="relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400 rounded-xl p-4 group hover:bg-gradient-to-r from-[#086788] to-[#07A0C3]">
      <Image
